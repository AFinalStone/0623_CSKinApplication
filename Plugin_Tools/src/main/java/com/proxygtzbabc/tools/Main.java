...
//        classesDex.renameTo(new File(apkTemp, "classes.dex"));
        File unSignedApk = new File("builder/app-unsigned.apk");
        File apkTemp = new File("builder/temp");
        Zip.zip(apkTemp, unSignedApk);

        /**
         * 4、对齐与签名
         */
        File alignedApk = new File("builder/app-unsigned-aligned.apk");
...
// pass:别名密码 --out  out.apk in.apk
        ...
        File jks = new File("signature/" + SIGN_FINE_NAME + ".jks");
